...
Public Class ClientGUI
    ...
    Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs) Handles ToolStripButton1.Click
        Try
            If Not _Settings.InitialURL = "" Then
                Dim newuri As New Uri(EnvManager.ResolveEnvironmentVariables(_ParentInstance.EnvironmentRuntimeVariables, _Settings.InitialURL))
                _ParentInstance.CurrentLogInstance.WriteLogEntry("Navigate to homepage: " & newuri.AbsolutePath, Me.GetType, LogEntryTypeEnum.Info, LogEntryLevelEnum.Debug)
                WebView1.Navigate(newuri)
            End If
        Catch ex As Exception
            _ParentInstance.CurrentLogInstance.WriteLogEntry("Navigate to URI: Error.", Me.GetType, LogEntryTypeEnum.ErrorL, LogEntryLevelEnum.Debug, Err)
        ...
        Try
            If Not ToolStripComboBox1.Text = "" Then
                If e.KeyCode = 13 Then
                    If Not ToolStripComboBox1.Text.ToLower.StartsWith("http://") Or Not ToolStripComboBox1.Text.ToLower.StartsWith("https://") Then
                        ToolStripComboBox1.Text = "http://" & ToolStripComboBox1.Text
                    End If

                    Dim newuri As New Uri(EnvManager.ResolveEnvironmentVariables(_ParentInstance.EnvironmentRuntimeVariables, ToolStripComboBox1.Text))
                    _ParentInstance.CurrentLogInstance.WriteLogEntry("Navigate to custom URI: " & newuri.AbsolutePath, Me.GetType, LogEntryTypeEnum.Info, LogEntryLevelEnum.Debug)
                    WebView1.Navigate(newuri)
