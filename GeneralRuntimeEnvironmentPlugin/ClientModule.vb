...
Public Module ClientModule
    Public Class Client
        ...
        Public ReadOnly Property PluginName As String Implements ICSToolInterface.PluginName
            Get
                Return "General Runtime Environment Provider"
            End Get
        End Property
        ...
        Public ReadOnly Property EnvironmentProviderClass As EnvironmentProvider Implements ICSToolInterface.EnvironmentProviderClass
            Get
                ...
                uu.EnvironmentVariables.Add(CurrentRemoteClientIPHostname)
                Dim CurrentRemoteClientIPHostnameCompat As New EnvironmentEntry
                CurrentRemoteClientIPHostnameCompat.ValueName = "Clientname"
                CurrentRemoteClientIPHostnameCompat.ValueData = CurrentIPHostname
                uu.EnvironmentVariables.Add(CurrentRemoteClientIPHostnameCompat)
                Dim PreviousRemoteClientIPHostname As New EnvironmentEntry
                PreviousRemoteClientIPHostname.ValueName = "PreviousRemoteClientIPHostname"
                PreviousRemoteClientIPHostname.ValueData = PrivIPHostname
                uu.EnvironmentVariables.Add(PreviousRemoteClientIPHostname)
        ...
        Public Function RaiseActions(HostnameOrIP As String) As Boolean Implements ICSToolInterface.RaiseActions
            Try
                PrivIPHostname = CurrentIPHostname
                CurrentIPHostname = HostnameOrIP
