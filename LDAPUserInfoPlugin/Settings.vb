...
<Serializable> Public Class Settings
    ...
    Public Property DirectorySearcherSearchWindowString As String = "(%and% (objectClass=user)(%SEARCHATTRIBUTE%=%SEARCHSTRING%))"
    ...
    Public Property RefreshLayoutAtSizeChange As Boolean = True
    Public Property LDAPInfoEntryCollection As New List(Of LDAPInfoEntry)
End Class

<Serializable> Public Class LDAPInfoEntry
    Public Property DisplayName As String = ""
    Public Property DisplaySize As Integer = 250
