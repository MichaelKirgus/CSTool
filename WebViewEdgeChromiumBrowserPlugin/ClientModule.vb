...
Public Module ClientModule
    Public Class Client
        ...
        Public ReadOnly Property UserControlIcon As Icon Implements ICSToolInterface.UserControlIcon
            Get
                Return My.Resources.ClientRes.emblem_web
            End Get
        End Property
        ...
        Public Function RaiseActions(HostnameOrIP As String) As Boolean Implements ICSToolInterface.RaiseActions
            GUIHandle.RaiseAction(HostnameOrIP)
            Return True
        End Function
        ...
        Public Function GetCredential() As CredentialEntry Implements ICSToolInterface.GetCredential
            Throw New NotImplementedException()
        End Function
    End Class
End Module
