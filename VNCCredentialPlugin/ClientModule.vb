...
Public Module ClientModule
    Public Class Client
        ...
        Public CredentialKey As String = "VNCCredentials"
        Public WindowsCredentialMessage As String = "Additional login information is required to use this tool. Please enter your VNC user data."
        Public WindowsCredentialCaption As String = "VNC Credentials"
        ...
        Public ReadOnly Property PluginName As String Implements ICSToolInterface.PluginName
            Get
                Return "VNC Credential Provider"
            End Get
        End Property
