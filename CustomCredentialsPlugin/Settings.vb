...
<Serializable> Public Class Settings
    ...
    <Serializable> Public Class CustomCredentialEntry
        ...
        Public Property CredentialLocation As CredentialLocationEnum = CredentialLocationEnum.PluginSettings
        ...
        Public Property UserAppDataFilename As String = ""
        ...
        Public Property WindowsCredentialMessage As String = "Additional login information is required to use this tool. Please enter your *CUSTOM* credentials."
        Public Property WindowsCredentialCaption As String = "*CUSTOM* Credentials"
    End Class
